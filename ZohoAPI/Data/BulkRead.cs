	...
	public class BulkRead
	{
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					if (actionHandler is ActionWrapper)
					{
						...
						Com.Zoho.Crm.API.BulkRead.ActionWrapper actionWrapper = (ActionWrapper)actionHandler;
						...
						foreach (ActionResponse actionResponse in actionResponses)
						{
							...
							if (actionResponse is SuccessResponse)
							{
								...
								Com.Zoho.Crm.API.BulkRead.SuccessResponse successResponse = (SuccessResponse)actionResponse;
		...
		public static void GetBulkReadJobDetails(long jobId)
		{
			...
			if (response != null)
			{
				...
				{
					//Get object from response
					Com.Zoho.Crm.API.BulkRead.ResponseHandler responseHandler = response.Object;

					if (responseHandler is ResponseWrapper)
					{
						//Get the received ResponseWrapper instance
						ResponseWrapper responseWrapper = (Com.Zoho.Crm.API.BulkRead.ResponseWrapper)responseHandler;
					...
					//Check if the request returned an exception
					else if (responseHandler is Com.Zoho.Crm.API.BulkRead.APIException)
					{
						//Get the received APIException instance
						Com.Zoho.Crm.API.BulkRead.APIException exception = (Com.Zoho.Crm.API.BulkRead.APIException)responseHandler;
		...
		public static void DownloadResult(long jobId, string destinationFolder)
		{
			...
			APIResponse<Com.Zoho.Crm.API.BulkRead.ResponseHandler> response = bulkReadOperations.DownloadResult(jobId);
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					{
						//Get the received APIException instance
						Com.Zoho.Crm.API.BulkRead.APIException exception = (APIException)responseHandler;
