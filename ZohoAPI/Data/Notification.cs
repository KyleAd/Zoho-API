...
namespace ZohoAPI.Data
{
	public class Notification
	{
		...
		public static void EnableNotifications()
		{
			...
			List<Com.Zoho.Crm.API.Notification.Notification> notifications = new List<Com.Zoho.Crm.API.Notification.Notification>();
							...
							if (actionResponse is SuccessResponse)
							{
								...
								foreach (KeyValuePair<string, object> entry in successResponse.Details)
								{
									if (entry.Value is IList && ((IList)entry.Value).Count > 0)
									{
										...
										if (dataList.Count > 0 && dataList[0] is Com.Zoho.Crm.API.Notification.Notification)
										{
											List<Com.Zoho.Crm.API.Notification.Notification> eventList = (List<Com.Zoho.Crm.API.Notification.Notification>)dataList;

											foreach (Com.Zoho.Crm.API.Notification.Notification event1 in eventList)
											{
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					if (responseHandler is ResponseWrapper)
					{
						...
						List<Com.Zoho.Crm.API.Notification.Notification> notifications = responseWrapper.Watch;

						foreach (Com.Zoho.Crm.API.Notification.Notification notification in notifications)
						{
		...
		public static void UpdateNotifications()
		{
			...
			//List of Notification instances
			List<Com.Zoho.Crm.API.Notification.Notification> notificationList = new List<Com.Zoho.Crm.API.Notification.Notification>();
