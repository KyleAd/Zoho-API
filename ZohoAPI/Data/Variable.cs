...
namespace ZohoAPI.Data
{
    public class Variable
    {
                ...
                if (response.IsExpected)
                {
                    ...
                    if (responseHandler is ResponseWrapper)
                    {
                        ...
                        foreach (Com.Zoho.Crm.API.Variables.Variable variable in variables)
                        {
                            ...
                            Com.Zoho.Crm.API.VariableGroups.VariableGroup variableGroup = variable.VariableGroup;
        ...
        public static void CreateVariables()
        {
            ...
            Com.Zoho.Crm.API.VariableGroups.VariableGroup variableGroup = new Com.Zoho.Crm.API.VariableGroups.VariableGroup();
            ...
            variableGroup = new Com.Zoho.Crm.API.VariableGroups.VariableGroup();
