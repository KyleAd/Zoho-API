...
namespace ZohoAPI.Data
{
	public class BluePrint
	{
		...
		public static void GetBlueprint(string moduleAPIName, long recordId)
		{
			...
			APIResponse<Com.Zoho.Crm.API.BluePrint.ResponseHandler> response = bluePrintOperations.GetBlueprint();
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					Com.Zoho.Crm.API.BluePrint.ResponseHandler responseHandler = response.Object;

					if (responseHandler is Com.Zoho.Crm.API.BluePrint.ResponseWrapper)
					{
						//Get the received ResponseWrapper instance
						Com.Zoho.Crm.API.BluePrint.ResponseWrapper responseWrapper = (Com.Zoho.Crm.API.BluePrint.ResponseWrapper)responseHandler;
					...
					else if (responseHandler is Com.Zoho.Crm.API.BluePrint.APIException)
					{
						//Get the received APIException instance
						Com.Zoho.Crm.API.BluePrint.APIException exception = (Com.Zoho.Crm.API.BluePrint.APIException)responseHandler;
		...
		public static void UpdateBlueprint(string moduleAPIName, long recordId, long transitionId)
		{
			...
			Com.Zoho.Crm.API.BluePrint.BodyWrapper bodyWrapper = new Com.Zoho.Crm.API.BluePrint.BodyWrapper();
			...
			APIResponse<Com.Zoho.Crm.API.BluePrint.ActionResponse> response = bluePrintOperations.UpdateBlueprint(bodyWrapper);
			...
			if (response != null)
			{
				...
				{
					//Get object from response
					Com.Zoho.Crm.API.BluePrint.ActionResponse actionResponse = response.Object;

					//Check if the request is successful
					if (actionResponse is Com.Zoho.Crm.API.BluePrint.SuccessResponse)
					{
						//Get the received SuccessResponse instance
						Com.Zoho.Crm.API.BluePrint.SuccessResponse successResponse = (Com.Zoho.Crm.API.BluePrint.SuccessResponse)actionResponse;
					...
					//Check if the request returned an exception
					else if (actionResponse is Com.Zoho.Crm.API.BluePrint.APIException)
					{
						//Get the received APIException instance
						Com.Zoho.Crm.API.BluePrint.APIException exception = (Com.Zoho.Crm.API.BluePrint.APIException)actionResponse;
