...
namespace ZohoAPI.Data
{
    public class CustomView
    {
        ...
        public static void GetCustomViews(string moduleAPIName)
        {
            ...
            paramInstance.Add(Com.Zoho.Crm.API.CustomViews.CustomViewsOperations.GetCustomViewsParam.PAGE, 1);

            paramInstance.Add(Com.Zoho.Crm.API.CustomViews.CustomViewsOperations.GetCustomViewsParam.PER_PAGE, 2);
