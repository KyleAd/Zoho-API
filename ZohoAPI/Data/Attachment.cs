...
namespace ZohoAPI.Data
{
	public class Attachment
	{
		...
		public static void GetAttachments(string moduleAPIName, long recordId)
		{
			...
			APIResponse<Com.Zoho.Crm.API.Attachments.ResponseHandler> response = attachmentsOperations.GetAttachments(paramInstance);
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					Com.Zoho.Crm.API.Attachments.ResponseHandler responseHandler = response.Object;

					if (responseHandler is Com.Zoho.Crm.API.Attachments.ResponseWrapper)
					{
						//Get the received ResponseWrapper instance
						Com.Zoho.Crm.API.Attachments.ResponseWrapper responseWrapper = (Com.Zoho.Crm.API.Attachments.ResponseWrapper)responseHandler;
					...
					else if (responseHandler is Com.Zoho.Crm.API.Attachments.APIException)
					{
						//Get the received APIException instance
						Com.Zoho.Crm.API.Attachments.APIException exception = (Com.Zoho.Crm.API.Attachments.APIException)responseHandler;
		...
		public static void DeleteAttachments(string moduleAPIName, long recordId, List<long> attachmentIds)
		{
			...
			APIResponse<Com.Zoho.Crm.API.Attachments.ActionHandler> response = attachmentsOperations.DeleteAttachments(paramInstance);
		...
		public static void DownloadAttachment(string moduleAPIName, long recordId, long attachmentId, string destinationFolder)
		{
			...
			APIResponse<Com.Zoho.Crm.API.Attachments.ResponseHandler> response = attachmentsOperations.DownloadAttachment(attachmentId);
			...
			if (response != null)
			{
				...
				if (response.IsExpected)
				{
					...
					if (responseHandler is Com.Zoho.Crm.API.Attachments.FileBodyWrapper)
					{
						//Get the received FileBodyWrapper instance
						Com.Zoho.Crm.API.Attachments.FileBodyWrapper fileBodyWrapper = (Com.Zoho.Crm.API.Attachments.FileBodyWrapper)responseHandler;
		...
		public static void DeleteAttachment(string moduleAPIName, long recordId, long attachmentId)
		{
			...
			APIResponse<Com.Zoho.Crm.API.Attachments.ActionHandler> response = attachmentsOperations.DeleteAttachment(attachmentId);
		...
		public static void UploadLinkAttachments(string moduleAPIName, long recordId, string attachmentURL)
		{
			...
			APIResponse<Com.Zoho.Crm.API.Attachments.ActionHandler> response = attachmentsOperations.UploadLinkAttachment(paramInstance);
