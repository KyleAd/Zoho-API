...
namespace ZohoAPI.Data.Threading.SingleUser
{
    public class SingleThread
    {
        ...
        public void GetContactRoles()
        {
            try
            {
                ...
                APIResponse<Com.Zoho.Crm.API.ContactRoles.ResponseHandler> response = contactRolesOperations.GetContactRoles();
                ...
                if (response != null)
                {
                    ...
                    {
                        //Get object from response
                        Com.Zoho.Crm.API.ContactRoles.ResponseHandler responseHandler = response.Object;

                        if (responseHandler is Com.Zoho.Crm.API.ContactRoles.ResponseWrapper)
                        {
                            //Get the received ResponseWrapper instance
                            Com.Zoho.Crm.API.ContactRoles.ResponseWrapper responseWrapper = (Com.Zoho.Crm.API.ContactRoles.ResponseWrapper)responseHandler;
                        ...
                        //Check if the request returned an exception
                        else if (responseHandler is Com.Zoho.Crm.API.ContactRoles.APIException)
                        {
                            //Get the received APIException instance
                            Com.Zoho.Crm.API.ContactRoles.APIException exception = (Com.Zoho.Crm.API.ContactRoles.APIException)responseHandler;
